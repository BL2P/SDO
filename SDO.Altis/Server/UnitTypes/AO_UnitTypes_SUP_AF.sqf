...
//--- Millitary 
	// Commander
		SDO_u_AO_com           = 	"sub_ins_af_off";
	// Squad leader
		SDO_u_AO_sl            = "sub_ins_af_sl";
	  // TeamLeader
		SDO_u_AO_tl            = 	"sub_ins_af_tl";
	// Lite
		SDO_u_AO_lite       = "sub_ins_af_lite";
	// Soldier
		SDO_u_AO_rifle       = "sub_ins_af_rifleman";
	// Grenade launcher
		SDO_u_AO_gl            = "sub_ins_af_gl";
	// Assault rifle
		SDO_u_AO_ar            = "sub_ins_af_mg";
	// Anti tank
		SDO_u_AO_at            = "sub_ins_af_lat";
	// Medic
		SDO_u_AO_med         = "sub_ins_af_medic";
	// Anti air
		SDO_u_AO_aa            = "sub_ins_af_aa";
	// Assistant anti air
		SDO_u_AO_ammo           = "sub_ins_af_ammo";
	// Engineer
		SDO_u_AO_rep            = "sub_ins_af_engineer";
	// Explosives
		SDO_u_AO_exp            =  "sub_ins_af_exp";
	// Marksman
		SDO_u_AO_marksman      = "sub_ins_af_sniper";
	// Marksman
		SDO_u_AO_spotter_sniper        = "sub_ins_af_tl";
	// Sniper
		SDO_u_AO_sniper        = "sub_ins_af_sniper";
	 // Crew
		SDO_u_AO_veh_crew		 = "sub_ins_af_crew";
...
//---Support types
	 SDO_Support_vehicles = 
		[
			"sub_ins_af_offroad_repair"
		];	
//---Armed car types
	 SDO_Armed_Cars = 
		[
			"sub_ins_af_offroad_armed"
		];
 //---BMP types
	 SDO_APC_vehicles = 
		[
