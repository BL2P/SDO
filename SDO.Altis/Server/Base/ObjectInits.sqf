		...
		//--- Vehicles
			...
			//--- trucks
				if (
					...
					{
						_m = [_obj,300,0] execVM "Server\Base\scripts\vehicle.sqf";
					};
				//--- Medical heal action
			...
			//--- Quads
				if (
					...
					(_obj == quad_12)) then 
					{
						_m = [_obj,30,1800] execVM "Server\Base\scripts\vehicle.sqf";
					};
			...
			//--- hunters
				if (
					...
					(_obj == car_8)) then 
					{
						//_m = [_obj,300,43200] execVM "Server\Base\scripts\vehicle.sqf";
						_m = [_obj,300,0] execVM "Server\Base\scripts\vehicle.sqf";
					};
			...
			//--- little birds	
				if (
					...
					(_obj == LB_2)) then 
					{
						_m = [_obj,600,0] execVM "Server\Base\scripts\vehicle.sqf";
					};
