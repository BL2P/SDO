hmg_camp = {
	...
	_gunner1 = _campgun1group createUnit [SDO_u_AO_rifle, _newpos, [], 0, "NONE"];
	...
	_soldier = _campgun1group createUnit [SDO_u_AO_rifle, _newpos, [], 0, "NONE"];
	doStop _soldier;
	...
	_newpos = [_bagspos, 1, (_dir + 180)] call BIS_fnc_relPos;
	_gunner2 = _campgun2group createUnit [SDO_u_AO_rifle, _newpos, [], 0, "NONE"];
	...
	_newpos = [_bagspos, 5, _dir - 90] call BIS_fnc_relPos;
	_soldier = _campgun2group createUnit [SDO_u_AO_rifle, _newpos, [], 0, "NONE"];
	doStop _soldier;
	
	_soldier = _campgroup createUnit [SDO_u_AO_rifle, _pos, [], 0, "NONE"];
	doStop _soldier;
	_newpos = _pos; _newpos set [2, 1];
	_soldier = _campgroup createUnit [SDO_u_AO_rifle, _newpos, [], 0, "NONE"];
	doStop _soldier;
	true;
};