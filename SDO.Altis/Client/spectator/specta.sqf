...
spectate_events = compile preprocessFileLineNumbers ("Client\spectator\specta_events.sqf");
...
RefreshPlayerList = compile preprocessFileLineNumbers "Client\spectator\RefreshPlayerList.sqf";
FreeLookMovementHandler = compile preprocessFileLineNumbers "Client\spectator\FreeLookMovementHandler.sqf";
CameraMenuHandler = compile preprocessFileLineNumbers "Client\spectator\CameraMenuHandler.sqf";
PlayerMenuHandler = compile preprocessFileLineNumbers "Client\spectator\PlayerMenuHandler.sqf";
KEGsShowCombatMode = compile preprocessFileLineNumbers "Client\spectator\specta_combatmode.sqf";
...
//if !( f_var_debugMode == 1 ) then {
//	[_player, _killer, "noWait"] execVM ("Client\spectator\specta.sqf");
//};
